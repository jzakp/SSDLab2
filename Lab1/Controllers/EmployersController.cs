...
namespace Lab1.Controllers
{
    ...
    public class EmployersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumber,Website,IncorpporatedDate")] Employer employer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumber,Website,IncorpporatedDate")] Employer employer)
        {
            if (id != employer.Id)
            {
                return NotFound();
